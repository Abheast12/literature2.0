...
// Initialize managers
const lobbyManager = new lobbies_1.LobbyManager();
...
io.on("connection", (socket) => {
    ...
    socket.on("lobby:start", (data, callback) => {
        try {
            ...
            const players = lobby.players.map(playerId => ({
                id: playerId,
    ...
    socket.on("game:declare", (data, callback) => {
        try {
            ...
            const gameEnded = gameState.team1Sets.length + gameState.team2Sets.length >= 9 ||
